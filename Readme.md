...
FanxyWsdl post-processes C# proxy code for WSDL service definitions generated by tools such as `wsdl.exe`, `svcutil.exe`, or *Visual Studio > Add Service Reference* and introduces the following enhancements:
