...
Post-process C# code generated by `wsdl.exe` and enhance the code.

- use C# naming conventions
- make it possible to rename things
- insert documentation (`summary` tags)
- clean up code

## Usage

1. Generate C# proxy classes from WSDL file,
   e.g. `wsdl.exe https://example.com/ExampleService/?wsdl`
2. Run _FancyWsdl_ on generated code,
...
2. Run _FancyWsdl_ on generated code and pass service definition,
...
[System.Xml.Serialization.XmlTypeAttribute(Namespace = "http://dpd.com/common/service/types/ShipmentService/4.3")]
public partial class parcelInformationType {
